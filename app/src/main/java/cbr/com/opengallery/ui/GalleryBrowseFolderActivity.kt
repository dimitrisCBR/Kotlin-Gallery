...
import cbr.com.opengallery.util.getAllImagesUnderFolder
...
class GalleryBrowseFolderActivity : BaseActivity(), FileSelectionListener {
    ...
    companion object {
        ...
        private val INTENT_EXTRA_FOLDER = "INTENT_EXTRA_FOLDER"
    ...
    private fun refreshContent(folder: File) {
        getAllImagesUnderFolder(this@GalleryBrowseFolderActivity, folder)
                .toObservable()
                .toList()
